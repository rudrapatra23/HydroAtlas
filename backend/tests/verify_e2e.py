...
Tests that get_by_period correctly filters by variable for all three variable types,
and that the variable is required (no None allowed).

Run: python tests/verify_e2e.py
Requires: DATABASE_URL in .env, sqlalchemy, asyncpg
"""
